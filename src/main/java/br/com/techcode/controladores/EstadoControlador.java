...
@URLMappings(mappings = {
    @URLMapping(id = "novo-estado", pattern = "/cadastro/estado/novo/", viewId = "/faces/cadastro/estado/editar.xhtml"),
    @URLMapping(id = "editar-estado", pattern = "/cadastro/estado/editar/#{estadoControlador.id}/", viewId = "/faces/cadastro/estado/editar.xhtml"),
    @URLMapping(id = "listar-estado", pattern = "/cadastro/estado/listar/", viewId = "/faces/cadastro/estado/listar.xhtml"),
    @URLMapping(id = "ver-estado", pattern = "/cadastro/estado/ver/#{estadoControlador.id}/", viewId = "/faces/cadastro/estado/visualizar.xhtml")
})
