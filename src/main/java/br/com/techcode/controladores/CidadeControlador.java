...
import br.com.techcode.negocios.CidadeFacade;
import br.com.techcode.negocios.EstadoFacade;
...
@URLMappings(mappings = {
    @URLMapping(id = "novo-cidade", pattern = "/cadastro/cidade/novo/", viewId = "/faces/cadastro/cidade/editar.xhtml"),
    @URLMapping(id = "editar-cidade", pattern = "/cadastro/cidade/editar/#{cidadeControlador.id}/", viewId = "/faces/cadastro/cidade/editar.xhtml"),
    @URLMapping(id = "listar-cidade", pattern = "/cadastro/cidade/listar/", viewId = "/faces/cadastro/cidade/listar.xhtml"),
    @URLMapping(id = "ver-cidade", pattern = "/cadastro/cidade/ver/#{cidadeControlador.id}/", viewId = "/faces/cadastro/cidade/visualizar.xhtml")
})
